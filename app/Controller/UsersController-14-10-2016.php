...
//                }
    ...
    public function signup($type = NULL) {
        ...
        $this->set(compact('title_for_layout','countries','states','signup_type'));
    }
...
//            exit();
        ...
        $this->set(compact('countries', 'states', 'cities','userDetails'));
...
//        exit();
  ...
  public function ajaxremoveWishlist(){
    ...
    public function edit_company_details(){
        ...
        // pr($states); exit;
        $this->set(compact('countries','states','cities','CompanyDetail','userid'));
