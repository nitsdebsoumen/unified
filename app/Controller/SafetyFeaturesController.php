...
class SafetyFeaturesController extends AppController {
 ...
 */
	...
	public $uses = array('SafetyFeature','CashPayment','UserReport','Post','Setting');
 ...
 */
        public function ajax_save()
        {
            ...
            {
                $this->request->data['SafetyFeature']['user_id'] = $userid;
                if($this->SafetyFeature->save($this->request->data))
                {
                    $id=$this->SafetyFeature->getLastInsertId();
                    $rarray = array('type' => 'success','id' => $id);
