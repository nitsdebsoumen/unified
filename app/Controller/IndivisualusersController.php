 ...
 */
class IndivisualusersController extends AppController {
    
    public $uses = array('User', 'Adminrole');
    ...
    public function admin_index() {
        ...
        $options = array('conditions' => array('User.is_admin !=' => 1, 'User.admin_type' => 4), 'order' => array('User.id' => 'desc'));
