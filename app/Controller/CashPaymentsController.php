...
class CashPaymentsController extends AppController {
 ...
 */
	...
	public $uses = array('CashPayment','UserReport','Post','Setting');
 ...
 */
        public function ajax_save()
        {
            ...
            {
                $this->request->data['CashPayment']['user_id'] = $userid;
                if($this->CashPayment->save($this->request->data))
                {
