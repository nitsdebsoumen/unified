...
//                }
    ...
    public function editprofile() {
        ...
        $lgas = $this->User->Lga->find('list', array('fields' => array('Lga.id', 'Lga.local_name')));
        //pr($states);
...
//        exit();
    ...
    public function coursefilter($slug = NULL) {
        $category_dtls=$this->Category->find('first',array('conditions'=>array('Category.slug'=>$slug),'fields'=>array('id')));
  ...
  public function ajaxremoveWishlist(){
    ...
    public function edit_company_details(){
        ...
        $this->loadModel('Lga');
        $lgas = $this->Lga->find('list', array('fields' => array('Lga.id', 'Lga.local_name')));
        // pr($states); exit;
