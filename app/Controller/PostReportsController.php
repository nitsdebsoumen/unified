...
class PostReportsController extends AppController {
 ...
 */
	...
	public $uses = array('PostReport','Post','Setting');
 ...
 */
        public function ajax_save()
        {
            ...
            {
                $this->request->data['PostReport']['user_id'] = $userid;
                if($this->PostReport->save($this->request->data))
                {
