							...
							<div class="offer-new">
								...
								<div class="col rating-holder">
									<div class="rating">
										...
										<span class="star"><i class="fa fa-star"></i> </span>
										<span class="star"><i class="fa fa-star"></i> </span>
										<div class="rating-summary">(23 reviews)</div>
									</div>
								</div>
		  ...
		  <p id="paymentmsg"> </p>
        	...
        	<div class="col-md-12 form-group">
		  	...
		  	<div class="col-sm-12" style="margin-bottom:20px;">
		    	...
		    	<div class="col-sm-8">
		    			<div class="form-group">
					  <input type="number" min="0" class="form-control" id="cardnumber" name="cardnumber" placeholder="Card Number" disabled="disabled">
					</div>
		    	</div>
  ...
  <div class="scroll-modal">
    <div class="personals">
        ...
        <div class="rating-summary-holder">
        	<div class="rating">
            <span class="star"><i class="fa fa-star"></i> </span><span class="star"><i class="fa fa-star"></i> </span><span class="star"><i class="fa fa-star"></i> </span><span class="star"><i class="fa fa-star"></i> </span><span class="star"><i class="fa fa-star"></i> </span> <span>23</span>
            </div>
        </div>
    </div>
    <div class="offer-details">
...
<script>
function viewOffer(tid,bid,uid,userImg,userName,userAmount,userComment,userDesc){
	console.log(userImg);
