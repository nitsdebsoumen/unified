...
<div class="users index">
	<h2 style="width:100%;float:left;"><?php echo __('Corporate Users'); ?></h2>
	<tr>
            <td style="width:70%;border:0px solid red;">&nbsp;</td>
<a href="<?php echo($this->webroot);?>admin/corporateusers/add" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Add New Corporate User</a>  
        </tr>
