                    ...
                    <div class="row state-overview">
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="panel purple">
                                ...
                                <div class="state-value">
                                    <div class="value"><?php echo $no_of_user; ?></div>
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="panel red">
                                ...
                                <div class="state-value">
                                    <div class="value"><?php echo $total_order; ?></div>
                    ...
                    <div class="row state-overview">
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="panel blue">
                                ...
                                <div class="state-value">
                                    <div class="value"><?php echo $total_revenue; ?></div>
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="panel green">
                                ...
                                <div class="state-value">
                                    <div class="value"><?php echo $no_of_course; ?></div>
                        ...
                        <div class="panel-body">
                            <ul class="goal-progress">
                                <li>
                                    ...
                                    <div class="details">
                                        <div class="title">
                                            <a href="#"><?php echo $category_detail['Category']['category_name']; ?></a> 
                                        </div>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo round(($category_detail['Category']['click_count']/$total_click)*100);?>%">
                                                <span class=""><?php echo round(($category_detail['Category']['click_count']/$total_click)*100);?>%</span>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
