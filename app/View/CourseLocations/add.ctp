...
<fieldset>
 ...
 <?php
  ...
  ?>
   ...
   <div class="form-group profile-field">
        <?php
           echo $this->Form->input('address',array( 'type' => 'text','class'=>'form-control'));
        ?>
   </div>

  <div class="form-group profile-field">
        <?php
           echo $this->Form->input('nearest_bus_stop',array( 'type' => 'text','class'=>'form-control'));
        ?>
   </div>
    ...
    <div class="form-group profile-field">
        <?php
           echo $this->Form->input('street',array( 'type' => 'text','class'=>'form-control'));
        ?>
   </div>
