<div class="col-md-3">
    <div class="update-profile-pic" style="cursor:pointer;">
        <span id="replaceimage"><img src="<?php if (isset($userdetails['User']['user_image']) && $userdetails['User']['user_image'] != '') { ?><?php echo $this->webroot; ?>user_images/<?php
                ...
                echo $this->webroot;
                ?>user_images/default.png<?php } ?> " width="190" height="190" alt=""/></span>
    ...
    <div class="left_bar">
        ...
        <ul>
            ...
            <li>
                <a href="<?php echo $this->webroot; ?>accreditations/index"><i class="fa fa-tag icon" aria-hidden="true"></i> <?php echo 'Accreditations'; ?></a>
            </li>
            ...
            <li>
                <a href="<?php echo $this->webroot .'users/update_profile'; ?>"><i class="fa fa-user icon" aria-hidden="true"></i><?php echo PROFILE_DETAILS; ?></a>
            </li>
            <li>
            ...
            { ?>
            <li>
                <a href="<?php echo $this->webroot; ?>users/user_dashboard/"><i class="fa fa-user icon" aria-hidden="true"></i> <?php echo "Dashboard"; ?></a>
            </li>
            <li>
                <a href="<?php echo $this->webroot; ?>wishlists/index"><i class="fa fa-heart icon" aria-hidden="true"></i> <?php echo WISHLIST; ?></a>
            </li>
            <li>
                <a href="<?php echo $this->webroot .'users/courselisting'; ?>"><i class="fa fa-user icon" aria-hidden="true"></i><?php echo 'Book a Course'; ?></a>
            </li>
            <?php } ?>
            ...
            <li>
                <a href="<?php echo $this->webroot; ?>ratings/user_reviews/<?php echo base64_encode($userdetails['User']['id']);?>"><i class="fa fa-star icon" aria-hidden="true"></i> <?php echo REVIEWS; ?></a>
            </li>
            ...
            { ?>
                ...
                <li>
                    <a href="<?php echo $this->webroot; ?>enquiries/user_enquiries/<?php echo base64_encode($userdetails['User']['id']);?>"><i class="fa fa-tag icon" aria-hidden="true"></i> <?php echo 'Enquiries'; ?></a>
                </li>

                  <?php   
                  if($userdetails['KycStatus']['varification_status']==1){ ?>
            ...
            <?php
                    ...
                    <li>
                        Verify Your KYC to Manage Courses.
                    </li>
            <?php } }
            }
            ?>
     ...
     <!--        <li> <a href="<?php echo $this->webroot; ?>students"><i class="fa fa-bars" aria-hidden="true"></i><?php echo STUDENT_MANAGEMENT; ?></a>
        ...
        <!--     <li>
            ...
            <?php
            if ( $userdetails['User']['admin_type']== 3 )
            { ?>
            ...
            { ?>
            <li>
                <a href="<?php echo $this->webroot; ?>suggest_categories/add"><i class="fa fa-plus icon" aria-hidden="true"></i><?php echo 'Suggest Categories'; ?></a>
            </li>
            <?php }*/ ?>
            ...
            if ( $userdetails['User']['admin_type']== 1 || $userdetails['User']['admin_type']== 2 )
            {
                ...
                ?>
            <li>
                <a href="<?php echo $this->webroot; ?>course_locations/add"><i class="fa fa-plus icon" aria-hidden="true"></i><?php echo 'Course Location'; ?></a>
            </li>
            <?php }
            }
            ?>
