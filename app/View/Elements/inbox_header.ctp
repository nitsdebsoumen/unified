...
<div class="top_link">
		...
		<a class="active tooltip" onclick="gotoInbox()">Inbox</a>
		<a class="tooltip" onclick="gotoSent()">Send Message</a>
                <a class="tooltip" href="<?php echo($this->webroot);?>inbox_messages/inbox_index">Admin Message</a>
		<!--<a class="tooltip" onclick="gotoSpam()">Label Message</a>
		<a class="tooltip" onclick="gotoFlag()">Flag Message</a>-->
		<a class="tooltip" onclick="gotoArchive()">Archive</a>
...
<script>
function showMessage(sid,name){
//alert(sid+'|'+name);
$('#SentMessageReceiverId').val(sid);
$('#sendName').html(name);
$('#MsgDiv').show();
$('html, body').animate({
