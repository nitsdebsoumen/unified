        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="right_bar">
                    ...
                    <div class="form-group profile-field">
                        <label for="" class="col-sm-3 right-text"></label>
                        <div class="col-sm-9">
                            <label><a href="<?php echo $this->webroot . 'suggest_categories/add'; ?>"><?php echo "Suggest Categories"; ?></a></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group profile-field">
                        ...
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('CourseLocation',array('class'=>'form-control multipleSelect','options'=>$locations,'multiple' => true,'label'=>FALSE,'div' => FALSE)); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group profile-field">
                        <label for="" class="col-sm-3 right-text"></label>
                        <div class="col-sm-9">
                            <label><a href="<?php echo $this->webroot . 'course_locations/add'; ?>"><?php echo "Add Course Location"; ?></a></label>
                        </div>
                    </div>
